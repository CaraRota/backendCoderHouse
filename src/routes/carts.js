...
routerCart.put('/:cid/product/:pid', passportError('jwt'), authorization(['user']), modifyProductQty);
routerCart.delete('/:cid/product/:pid', passportError('jwt'), authorization(['user']), removeProductFromCart);
